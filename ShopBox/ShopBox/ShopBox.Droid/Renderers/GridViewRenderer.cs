...
using FormsGridView = ShopBox.UserControl.GridView;
...
namespace ShopBox.Droid.Renderers
{
    ...
    public class GridViewAdapter : RecyclerView.Adapter
    {
        ...
        public override RecyclerView.ViewHolder OnCreateViewHolder(ViewGroup parent, int viewType)
        {
            ...
            Element.ItemTemplate.CreateContent() as ShopBox.UserControl.FastGridCell :
            Element.GroupHeaderTemplate.CreateContent() as ShopBox.UserControl.FastGridCell;
    ...
    public class GridViewCellContainer : ViewGroup
    {
        ...
        ShopBox.UserControl.FastGridCell _viewCell;
        ...
        public GridViewCellContainer(Context context, ShopBox.UserControl.FastGridCell viewCell, global::Android.Views.View parent, Xamarin.Forms.Size initialCellSize) : base(context)
        {
